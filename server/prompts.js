...
3. Zakaz nieistniejących ani zgadywanych \`rbxassetid://\`. Zamiast tego generuj dźwięki/UI proceduralnie (Instance.new("Sound") bez SoundId, cząstki z ParticleEmitter, tekst z TextLabel). W komentarzu możesz zaznaczyć, gdzie wstawić własny asset.
