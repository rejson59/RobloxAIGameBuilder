...
makeLabel(header, (PROJECT.tagline or PROJECT.summary or ""), UDim2.new(1, -20, 0, 34), UDim2.fromOffset(12, 32), theme.muted)

-- Sekcja 1: budowanie ---------------------------------------------
local sectionBuild = makeFrame(pad, UDim2.new(1, 0, 0, 116), UDim2.fromOffset(0, 80), theme.panel)
